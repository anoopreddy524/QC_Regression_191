...
public class JQCRefinance_CABPayment extends QCStore {
	public static void CABPayment(String SSN,String AppURL) throws InterruptedException
	{
		
			int lastrow=TestData.getLastRow((Aprop.getProperty("Refinance")));
			String sheetName=Aprop.getProperty("Refinance");
		       ...
		       Thread.sleep(4000);
				...
				Thread.sleep(5000);		
				    ...
				    driver.switchTo().defaultContent();
					 driver.switchTo().frame("mainFrame");
					 driver.switchTo().frame("main");
					 driver.findElement(locator(Aprop.getProperty("transactionList"))).sendKeys("Refinance");
