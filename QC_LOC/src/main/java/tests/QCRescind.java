					   ...
					   driver.switchTo().defaultContent();
						...
						Thread.sleep(2000);
							...
							for( String winHandle1 : driver.getWindowHandles())
							{
							 ...
							 driver.switchTo().frame("mainFrame");
							 driver.switchTo().frame("main");
							 driver.findElement(locator(Aprop.getProperty("transactionList"))).sendKeys("Rescind");
							 ...
							 //String ele= driver.findElement(locator(Aprop.getProperty("Rescind_loanAmt"))).getText();
							 driver.findElement(locator(Aprop.getProperty("Refinance_tenderType"))).sendKeys(TenderType);
							// driver.findElement(locator(Aprop.getProperty("Refinance_tenderAmt"))).sendKeys(ele);
