...
public class VQCAdminStoreSetup extends QCStore
{
	...
	try{
		...
		driver.findElement(locator(Aprop.getProperty("admin_store_setup_tab"))).click(); 
	...
	driver.findElement(locator(Aprop.getProperty("admin_store_config"))).click();
...
Thread.sleep(2000);
	...
	driver.findElement(locator(Aprop.getProperty("admin_store_nbr"))).sendKeys(StoreID);

	test.log(LogStatus.PASS, "Entered Store number "+StoreID);

	driver.findElement(locator(Aprop.getProperty("admin_store_submit_btn"))).click();
	...
	driver.findElement(locator(Aprop.getProperty("admin_store_status"))).sendKeys("Open");
	...
	Thread.sleep(2000);
	driver.findElement(locator(Aprop.getProperty("admin_store_ok_btn"))).click();
