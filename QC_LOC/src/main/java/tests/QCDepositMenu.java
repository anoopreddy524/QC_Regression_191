						   ...
						   driver.switchTo().defaultContent();
							...
							if(ESign_CollateralType.equalsIgnoreCase("ACH"))
							{
								driver.findElement(By.linkText("ACH")).click();
								 ...
								 driver.findElement(locator(Aprop.getProperty("deposit_ach_ilp"))).click();
								 test.log(LogStatus.PASS, "Clicked on Installment Loan");
							 Thread.sleep(2000);
							 driver.findElement(locator(Aprop.getProperty("deposit_ilp_ach_deposit"))).click();
							 ...
							 driver.findElement(locator(Aprop.getProperty("ACH_submit"))).click();
							 test.log(LogStatus.PASS, "Clicked on Submit button ");
							 driver.findElement(locator(Aprop.getProperty("deposit_ilp_deposit_type"))).sendKeys(RepresentmentType);
							...
							if(ESign_CollateralType.equalsIgnoreCase("CHECK"))
							{
								 ...
								 WebElement collateral=driver.findElement(locator(Aprop.getProperty("deposite_collateral_check")));
								 action.moveToElement(collateral).build().perform();
								 test.log(LogStatus.PASS, " Mouse hover on collateral check menu");
								 Thread.sleep(2000);
								 WebElement pdl=driver.findElement(locator(Aprop.getProperty("deposit_check_ilp")));
								 action.moveToElement(pdl).build().perform();
								 test.log(LogStatus.PASS, " Mouse hover on Installment loan menu");
								 Thread.sleep(3000);
								 driver.findElement(locator(Aprop.getProperty("deposit_ilp_deposit"))).click();
							...
							{
								Actions action = new Actions(driver);  
								 WebElement dc=driver.findElement(locator(Aprop.getProperty("DC")));
								 action.moveToElement(dc).build().perform();
								 test.log(LogStatus.PASS, " Mouse hover on collateral Debit Card menu");
								 Thread.sleep(2000);
								 WebElement pdl=driver.findElement(locator(Aprop.getProperty("DC_ilp")));
								 action.moveToElement(pdl).build().perform();
								 test.log(LogStatus.PASS, " Mouse hover on Installment loan menu");
								 Thread.sleep(3000);
								 driver.findElement(locator(Aprop.getProperty("DC_ilp_deposite"))).click();
