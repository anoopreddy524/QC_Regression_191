...
public class VAdminLoginForBankruptcy extends QCStore{
	...
	public static void bankruptcy(WebDriver driver,String SSN,String AppURL) throws InterruptedException, MalformedURLException
	{
		int lastrow=TestData.getLastRow("Bankruptcy");
			...
			{		
				...
				test.log(LogStatus.INFO,"Admin Login For Bankruptcy"+ Aprop.getProperty("adminURL"));
