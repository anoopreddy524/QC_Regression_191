...
public class QCCSRHistory_BackUp extends QCStore{
	...
	public static String loan_paid_summary_total_paid_amt;
	public static String loan_paid_summary_repo_fee_paid;
	public static String loan_balance_inf_Current_Principal_Balance;
...
//Loan paid to date summary
					...
					/*	String loc_history_transaction_test= driver.findElement(locator(Aprop.getProperty("loc_history_transaction"))).getText();
						...
						if(Aprop.getProperty("CSR_URL").equalsIgnoreCase("https://qclocalauto.qfund.net/cc/demoIndex.do")){
						loan_paid_summary_total_paid_amt= driver.findElement(locator(Aprop.getProperty("loan_paid_summary_total_paid_amt"))).getText();
						loan_paid_summary_repo_fee_paid=driver.findElement(locator(Aprop.getProperty("loan_paid_summary_repo_fee_paid"))).getText();
						}else{
							loan_paid_summary_total_paid_amt= driver.findElement(By.xpath("//*[@id='revolvingCreditHistTable']/tbody/tr/td[3]/table/tbody/tr[28]/td/span[1]/b")).getText();
							loan_paid_summary_repo_fee_paid=driver.findElement(By.xpath("//*[@id='revolvingCreditHistTable']/tbody/tr/td[3]/table/tbody/tr[29]/td/span[1]/b")).getText();
						}
						...
						if(Aprop.getProperty("CSR_URL").equalsIgnoreCase("https://qclocalauto.qfund.net/cc/demoIndex.do")){
							...
							loan_balance_inf_Current_Principal_Balance=driver.findElement(locator(Aprop.getProperty("loan_balance_inf_Current_Principal_Balance"))).getText();
							
							}else{
								loan_balance_inf_Current_Principal_Balance=driver.findElement(By.xpath("//*[@id='revolvingCreditHistTable']/tbody/tr/td[3]/table/tbody/tr[20]/td/span[1]/b")).getText();
							}
