...
public class VQCCSRWriteOff_org extends QCStore {
			    ...
			    driver.switchTo().frame("main");
						...
						for (String winHandle : driver.getWindowHandles()) {
							if (!mainwindow.equalsIgnoreCase(winHandle)) {
								...
								loan_nbr = driver.findElement(locator(Aprop.getProperty("csr_loan_nbr1"))).getText();
								test.log(LogStatus.PASS, "Loan Number is" + loan_nbr);
								Thread.sleep(2000);
								String NextDueDate = driver.findElement(locator(Aprop.getProperty("csr_due_date1"))).getText();
