						   ...
						   driver.switchTo().defaultContent();
							...
							if(ESign_CollateralType.equalsIgnoreCase("ACH"))
							{
								driver.findElement(By.linkText("ACH")).click();
								 ...
								 driver.findElement(locator(Aprop.getProperty("deposit_ach_tlp"))).click();
								 test.log(LogStatus.PASS, "Clicked on Title Loan");
							 Thread.sleep(2000);
							 driver.findElement(locator(Aprop.getProperty("deposit_tlp_achdeposit"))).click();
							...
							if(ESign_CollateralType.equalsIgnoreCase("DEBIT CARD"))
							{
								Actions action = new Actions(driver);  
								 ...
								 Thread.sleep(2000);
								 WebElement pdl=driver.findElement(locator(Aprop.getProperty("deposit_debitcard_tlp")));
								 action.moveToElement(pdl).build().perform();
								 test.log(LogStatus.PASS, " Mouse hover on Title loan menu");
								 Thread.sleep(3000);
								 driver.findElement(locator(Aprop.getProperty("deposit_DC_tlpdeposit"))).click();
