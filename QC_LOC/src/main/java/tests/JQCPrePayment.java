...
public class JQCPrePayment extends QCStore{
	...
	public static void prePayment(String SSN,String AppURL){
		try{
			int lastrow=TestData.getLastRow((Aprop.getProperty("Pre_Payment")));
			String sheetName= Aprop.getProperty("Pre_Payment");
						...
						if(ESign_CollateralType.equalsIgnoreCase("ACH"))
						{
							for( String winHandle1 : driver.getWindowHandles())
							{
							 ...
							 if(Tender_Type.equalsIgnoreCase("Cash"))
								{
								 String Tender_Amt= driver.findElement(locator(Aprop.getProperty("Tender_Amt"))).getAttribute("value");
