			...
			try {
				...
				for (int row = 2; row <= lastrow; row++) {
					...
					if (SSN.equals(RegSSN)) {
						...
						{
							driver.findElement(locator(Aprop.getProperty("refinance_courtesy_call")))
									.sendKeys(ESign_CourtesyCallConsent);
							test.log(LogStatus.PASS, "Courtesy Call Consent selected as " + ESign_CourtesyCallConsent);
							Thread.sleep(2000);
							driver.findElement(By.xpath(" //*[@id='preferenceCall']")).click();
							test.log(LogStatus.PASS, "Esign preference selected as " + ESign_Preference);
							driver.findElement(locator(Aprop.getProperty("refinance_select_card"))).sendKeys("New Card");
							test.log(LogStatus.PASS, "Select card as : " + "NEW CARD");
							Thread.sleep(2000);

							driver.findElement(locator(Aprop.getProperty("refinance_select_card_type")))
									.sendKeys(cardType);
							test.log(LogStatus.PASS, "Enterd card Type  : " + cardType);

							driver.findElement(locator(Aprop.getProperty("refinance_card_number"))).sendKeys(cardNumber);
							test.log(LogStatus.PASS, "Card number is :" + cardNumber);

							driver.findElement(locator(Aprop.getProperty("refinance_exp_month"))).sendKeys(cardEx_month);
							...
							driver.findElement(locator(Aprop.getProperty("refinance_exp_year"))).sendKeys(cardEx_Year);
							...
							driver.findElement(locator(Aprop.getProperty("refinance_cvv"))).sendKeys(cvv);
							test.log(LogStatus.PASS, "Enterd CVV as " + cvv);
							driver.findElement(locator(Aprop.getProperty("refinance_card_holder_name")))
									.sendKeys(CardHolderName);
							test.log(LogStatus.PASS, "Card holder name is " + CardHolderName);

							driver.findElement(locator(Aprop.getProperty("refinance_dc_card_add"))).click();
						...
						String paymentAmount = driver.findElement(locator(Aprop.getProperty("refinance_payment_amount")))
								.getAttribute("value");
						...
						String rebate = driver.findElement(locator(Aprop.getProperty("refinance_rebate_amount")))
								.getAttribute("value");
						test.log(LogStatus.PASS, "Rebate amount is " + rebate);
						// String stepdownamount=
						// driver.findElement(locator(Aprop.getProperty("refinance_step_down_amount"))).getAttribute("value");
						test.log(LogStatus.PASS, "Step Same amount is " + pbalstr);
						Thread.sleep(2000);

						// driver.findElement(By.name("requestBean.password")).sendKeys(Esign_Password);
						driver.findElement(locator(Aprop.getProperty("refinance_password"))).sendKeys(Esign_Password);
						test.log(LogStatus.PASS, "Password enterd as: " + Esign_Password);

						Thread.sleep(5000);
						driver.findElement(locator(Aprop.getProperty("refinance_finish_button"))).click();
