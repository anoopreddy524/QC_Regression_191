...
public static void LOC() throws InterruptedException
{
	...
	//String LOCamount=driver.findElement(By.xpath("//*[@id='riskViewBdy']/table[3]/tbody/tr[1]/td/table/tbody/tr[3]/td/table/tbody/tr[3]/td[5]/table/tbody/tr[1]/td[2]")).getText();
	                                                //*[@id="errorMessage"]/form[1]/table[1]/tbody/tr[2]/td/table/tbody/tr[3]/td/table/tbody/tr[2]/td[2]/input
	//*[@id="LoanButtonId"]
	//*[@id="riskViewBdy"]/table[3]/tbody/tr[1]/td/table/tbody/tr[3]/td/table/tbody/tr[3]/td[5]/table/tbody/tr[1]/td[2]
	String LOCamount = driver.findElement(By.xpath("//*[@id='errorMessage']/form[1]/table[1]/tbody/tr[2]/td/table/tbody/tr[3]/td/table/tbody/tr[2]/td[2]/input")).getAttribute("value");
	...
	/*	if(!(ESign_LoanAmt.isEmpty()))
		{
			...
			e1.click();
			e1.sendKeys(Keys.chord(Keys.BACK_SPACE, Keys.BACK_SPACE,Keys.BACK_SPACE,Keys.BACK_SPACE,Keys.BACK_SPACE,Keys.BACK_SPACE,Keys.BACK_SPACE,Keys.BACK_SPACE)+LOCamount);
		...
		/*	else if(!(ESign_LoanAmt.isEmpty()))
			...
			{
			String disb= driver.findElement(By.name("advanceRequestBean.loanAmount")).getAttribute("value");
			driver.findElement(By.name("advanceRequestBean.disbAmtFirst")).sendKeys(disb);			
			test.log(LogStatus.PASS, "Disb amount enterd  as "+disb);
			}*/
