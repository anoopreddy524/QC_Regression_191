		...
		try{
			...
			{		
		       ...
		       Thread.sleep(4000);
				...
				Thread.sleep(3000);
				driver.findElement(locator(Aprop.getProperty("CmgDeposite"))).click();
				test.log(LogStatus.PASS, " click on CmgDeposite menu");
				Thread.sleep(2000);
				driver.switchTo().defaultContent();
				driver.switchTo().frame("mainFrame");
				driver.switchTo().frame("main");
				String check_Nbr=driver.findElement(locator(Aprop.getProperty("cmg_checkNbr"))).getText();
				...
				{
				driver.findElement(locator(Aprop.getProperty("CmgDeposite_select"))).click();
				test.log(LogStatus.PASS, " click on CmgDeposite_select menu");
				driver.findElement(locator(Aprop.getProperty("cmgDeposite_pin"))).sendKeys(PIN);
				test.log(LogStatus.PASS, "Enter cmgDeposite_pin menu");
				driver.findElement(locator(Aprop.getProperty("cmgFinishDeposite"))).click();
				...
				if(driver.findElement(locator(Aprop.getProperty("cmgSuccess"))).isDisplayed())
				{
