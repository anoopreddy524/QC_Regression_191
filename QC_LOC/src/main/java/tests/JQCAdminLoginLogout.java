...
public class JQCAdminLoginLogout extends QCStore {
	...
	public static void login(String SSN, String AppURL)
	{
		try{
			...
			int lastrow=TestData.getLastRow((Aprop.getProperty("Login")));
			String sheetName=Aprop.getProperty("Login");
			...
			{		
				...
				{	
					...
					Thread.sleep(4000);
					test.log(LogStatus.INFO, "Opened the CSR URL " +Aprop.getProperty("adminURL"));
					...
					driver.findElement(locator(Aprop.getProperty("admin_uname"))).clear();
					driver.findElement(locator(Aprop.getProperty("admin_uname"))).sendKeys(uname);
				    test.log(LogStatus.PASS, "Username is entered: "+uname);
				    driver.findElement(locator(Aprop.getProperty("admin_pwd"))).clear();
					driver.findElement(locator(Aprop.getProperty("admin_pwd"))).sendKeys(pwd);
				    test.log(LogStatus.PASS, "Password is entered: "+pwd);
				    driver.findElement(locator(Aprop.getProperty("admin_submit_btn"))).click();
