	...
	public static void safeAssign(String SSN,String AppURL)
	{
		...
		//	ExcelNew TestData = new ExcelNew(System.getProperty("user.dir")+Aprop.getProperty("QC_Store_NewLoan_Test_data_sheet_path")+FileName+".xls");  		 
				...
				{		
						...
						driver.findElement(locator(Aprop.getProperty("safe_assign_assign_link"))).click();
						...
						try{
							Thread.sleep(4000);
							driver.findElement(locator(Aprop.getProperty("safe_click_somewhere"))).click();
							driver.findElement(locator(Aprop.getProperty("safe_assign_next"))).click();
							...
							try{
								Thread.sleep(5000);
								driver.findElement(locator(Aprop.getProperty("safe_assign_yes_btn"))).click();
