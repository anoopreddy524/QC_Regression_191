					  ...
					  if(ProductID.equals("PDL"))
					    ...
					    if(ProductID.equals("LOC"))
						 ...
						 for( String winHandle1 : driver.getWindowHandles())
							...
							// encryption_date=driver.findElement(locator(Aprop.getProperty("encryption_date"))).getText();
							 encryption_transaction=driver.findElement(By.xpath("/html/body/table/tbody/tr/td/table/tbody/tr/td/table/tbody/tr[2]/td/table/tbody/tr[3]/td")).getText();
									 ...
									 //driver.findElement(locator(Aprop.getProperty("encryption_transaction_nbr"))).getText();
							// encryption_transaction_id=driver.findElement(locator(Aprop.getProperty("encryption_transaction_id"))).getText();
							 encryption_store=driver.findElement(locator(Aprop.getProperty("encryption_store_no"))).getText();
							// encryption_count=driver.findElement(locator(Aprop.getProperty("encryption_count"))).getText();
						 ...
						 driver.findElement(locator(Aprop.getProperty("encryption_no_btn"))).click();
