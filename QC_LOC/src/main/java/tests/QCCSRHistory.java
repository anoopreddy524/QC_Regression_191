	...
	public static void history(String SSN,String AppURL) throws InterruptedException
	{
		...
		{	
			...
			if(SSN.equals(RegSSN))
			{
				...
				{
					test.log(LogStatus.PASS, "Credit Limit->Expected value:"+loan_amount +"; == Actual value:"+loan_account_inf_loan_amt);
				}
				else
				{
					test.log(LogStatus.FAIL, "Credit Limit->Expected value:"+loan_amount +"; not equals to Actual value:"+loan_account_inf_loan_amt);
...
*/
				...
				if(loan_balance_inf_Remaining_Statement_Payment_Amount_test.equalsIgnoreCase(loan_balance_inf_Remaining_Current_Payment_Amount))
				{
					test.log(LogStatus.PASS, "Remaining_Statement_Payment_Amount->Expected value:"+loan_balance_inf_Remaining_Statement_Payment_Amount_test +"; == Actual value:"+loan_balance_inf_Remaining_Current_Payment_Amount);
				}
				else
				{
					test.log(LogStatus.FAIL, "Remaining_Statement_Payment_Amount->Expected value:"+loan_balance_inf_Remaining_Statement_Payment_Amount_test +"; not equals to Actual value:"+loan_balance_inf_Remaining_Current_Payment_Amount);
